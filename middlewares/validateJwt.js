...
module.exports = async (req, res, next) => {
  ...
  try {
    ...
    // Caso esteja tudo certo, nós então buscamos o usuário na base para saber se esse token não foi gerado através 
    // de alguma plataforma de gerador de JWT, por exemplo.
    ...
    // Se o usuário existe, colocamos ele em um campo no objeto res para que esteja disponível para outros middlewares que
