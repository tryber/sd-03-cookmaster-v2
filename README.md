...
- O nome do arquivo deve ser o ID da receita, com extensão `jpeg` (caso o arquivo tenha outra extensão, a converta para `jpeg`). As imagens devem estar disponíveis através da rota `/images/<id-da-receita>.jpeg` na API.
