...
- O nome do arquivo deve ser o ID da receita, com a extensão original do arquivo. As imagens devem estar disponíveis através da rota `/images/<id-da-receita>` na API.
