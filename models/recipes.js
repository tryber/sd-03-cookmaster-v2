...
const addImage = async (id, name, ingredients, preparation, userId, image) =>
  connect()
    .then((db) => db.collection('recipes').updateOne({ _id: ObjectId(id) }, { $set: { name, ingredients, preparation, userId, image } }))
